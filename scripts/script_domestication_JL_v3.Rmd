...
for (trait in listTraits) {
  ...
  effetBloc<-sauveBlock[trait,c("ConvFixe","DivFixe")]
...
pdf("Figure_rapport_debloc.pdf",width=7,height=5)
...
write.table(estRapport,"RapportSourdoughOther_debloc.csv",row.names=F,sep=";")
write.table(phenotypeC,"myDataCorr.csv",row.names=F,sep=";")
```
