...
```{r gene_pathway, warning=FALSE, message=FALSE}
...
```{r pathway_type, warning=FALSE, message=FALSE}
...
```{r run_genepath, warning=FALSE, message=FALSE}
...
queryGenePath$where[[1]][["value"]] <- "PDR18"
